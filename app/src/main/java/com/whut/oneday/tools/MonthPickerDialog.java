...
//月份选择器
public class MonthPickerDialog implements View.OnClickListener {
    private Dialog dialog;
    private Context context;
    private OnMonthPickListener monthPickListener;
    private StringScrollPicker yearPicker;
    ...
    private void initYearPicker(int start, int end) {
        ...
        yearPicker.setData(Arrays.asList(charSequences));
    }
    ...
    private void initializeComponents() {
        ...
        yearPicker.setOnSelectedListener(new ScrollPickerView.OnSelectedListener() {
            @Override
            public void onSelected(ScrollPickerView scrollPickerView, int i) {
                String value = yearList.get(i);
        ...
        if (index > -1) {
            yearPicker.setSelectedPosition(index);
        } else {
